...
Активировать: когда нужно настроить роутинг между AI-моделями или обойти блокировки API.

**Цель:** Использовать нужную модель в нужный момент, экономя деньги и обходя блокировки.

---

## Зачем

OmniRoute — это AI-шлюз, который роутит запросы между провайдерами. Из РФ он критичен: OpenAI и Anthropic заблокированы, DPI рвет соединения. OmniRoute через Hysteria 2 обходит все блокировки.
...
-灰ые запросы → Zhipu (обход блокировок)
